...
export default function About() {
  ...
  return (
    <section id="about" className="relative isolate scroll-mt-20 overflow-hidden border-b editorial-rule px-4 py-24 sm:px-6 lg:px-8 lg:py-36">
      <SectionRibbons variant="about" />
